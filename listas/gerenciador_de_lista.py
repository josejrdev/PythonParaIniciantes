"""
Programa que permite ao usuário gerenciar uma lista por meio de um
menu de opções. É possível adicionar ou remover itens dos tipos
float, int e string. Ao adicionar um item, o programa solicita seu
tipo e seu valor. Ao remover, verifica se o item informado existe
na lista antes de removê-lo. O programa continua executando até que
a opção de saída seja selecionada.
"""
lista = []
while True:
