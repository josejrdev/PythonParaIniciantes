"""
Programa que simula a venda de ingressos para cinco salas de cinema.
Exibe a quantidade de ingressos disponíveis em cada sala e permite ao
usuário escolher uma sala e informar a quantidade de ingressos que
deseja comprar. O programa valida a sala e a quantidade solicitada,
atualiza a quantidade de ingressos disponíveis após cada compra e
encerra quando o usuário informa 0.
"""
