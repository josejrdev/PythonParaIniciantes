"""
Programa que analisa uma lista de luminosidades e calcula a média
geral dos valores. Em seguida, identifica as luminosidades que estão
acima de 150% da média geral e determina a maior sequência contínua
de valores crescentes. Ao final, exibe a média geral, os valores acima
de 150% da média e a maior sequência crescente encontrada.
"""
listaLuminosidades = [
