"""
Programa que analisa uma lista de batimentos cardíacos dividida em
dois períodos de 30 valores. Calcula a média dos batimentos de cada
período, determina a variação entre as médias e armazena em uma nova
lista todos os batimentos cardíacos acima de 95. Ao final, exibe as
médias dos períodos, a variação entre elas e os valores acima de 95.
"""
