"""
Programa que divide uma lista de velocidades em três períodos do dia:
manhã, tarde e noite. Calcula a velocidade média de cada período e
compara as médias para identificar qual período apresentou a maior
velocidade média, sendo considerado o mais perigoso.
"""
listaVelocidades = [
