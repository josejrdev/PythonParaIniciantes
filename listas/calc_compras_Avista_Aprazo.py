"""
Programa que registra 15 transações de compra, classificando-as como
compras à vista ou a prazo de acordo com o código informado. Calcula
o valor total das compras à vista, o valor total das compras a prazo,
o valor total de todas as compras e o valor de cada uma das três
prestações das compras realizadas a prazo.
"""
somaAVista = 0
somaAPrazo = 0
for i in range(15):
