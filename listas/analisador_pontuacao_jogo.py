"""
Programa que divide uma lista de pontuações em duas metades, calcula
a soma dos valores de cada metade e compara os resultados. Ao final,
informa qual metade possui a maior soma ou se as duas somas são iguais.
"""
