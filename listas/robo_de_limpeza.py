"""
Programa que analisa uma lista de valores de consumo. Calcula a soma
dos dez primeiros e dos dez últimos valores da lista e, em seguida,
percorre a lista para identificar o maior bloco contínuo de cinco
valores e sua respectiva soma. Ao final, exibe os resultados obtidos.
"""
listaConsumo = [
