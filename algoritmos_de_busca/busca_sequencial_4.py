"""
Programa que solicita dois valores ao usuário e realiza uma busca
sequencial por ambos em uma lista. Ao final da busca, informa a posição
em que cada valor foi encontrado ou avisa caso algum deles não esteja
presente na lista.
"""
l = [15,7,27,39]
